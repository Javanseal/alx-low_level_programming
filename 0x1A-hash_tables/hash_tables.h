...
/**
 * str  hash_table_s - Hash table data struct.
 * @size: of the array
...
/**
 * str shash_node_s - Node of a sorted hash table
 * @key: string
 * key is unique in the HashTable
 * @value: corresponding to a key
 * @next: points to the next node of the List
...
/**
 * str shash_table_s - Sorted hash table data struct.
 * @size: of the array
 * @array: An array of size 
 * Each cell of this array is a pointer to the first node of a linked list,
 * we want our HashTable to use a Chaining collision handling
